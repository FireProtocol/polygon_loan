...
/**
 * @title fToken interface
 * @author Fire
 */
contract FTokenInterface is FireTokenCommon {
    bool public constant fToken = true;
     ...
     */
    event LiquidateBorrow(address _liquidator, address _borrower, uint _repayAmount, address _fTokenCollateral, uint _seizeTokens);
     ...
     */
    event NewComptroller(FireComptrollerInterface _oldComptroller, FireComptrollerInterface _newComptroller);
    ...
    function _setComptroller(FireComptrollerInterface _newComptroller) public returns (uint);
